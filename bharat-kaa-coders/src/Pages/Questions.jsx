...
const Questions = () => {
  return (
    <div className="flex justify-center mt-11 relative">
      <div className="flex flex-col items-center gap-9">
        ...
        <div className="gap-4 item-center flex justify-center flex-col items-center relative">
          <div
            className="text-white text-sm md:text-lg border-solid
                             border-gray-500 border-2 rounded-md p-2 md:p-5 w-11/12 md:w-5/5 cursor-pointer "
          >
            <p>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maiores
              sapiente blanditiis dicta maxime{" "}
            </p>
          </div>
          <div
            className="text-white text-sm md:text-lg border-solid
