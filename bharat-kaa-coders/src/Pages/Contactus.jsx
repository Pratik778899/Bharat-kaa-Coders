    ...
    return (
        <div className='flex justify-center'>
            ...
            <div className='flex justify-center md:mt-14 mt-9 '>
                ...
                <div>
                    <h2 className='text-2xl md:text-4xl font-semibold green-grade whitespace-nowrap'>Get in Touch</h2>
                ...
                <div>
                    <h1 className='text-2xl md:text-4xl font-semibold green-grade whitespace-nowrap '>Reach Out</h1>
                ...
                <div>
                    <h1 className='text-2xl md:text-4xl font-semibold green-grade whitespace-nowrap'>Connect With Us</h1>
                    <div className='text-white md:text-xl text-sm'>
