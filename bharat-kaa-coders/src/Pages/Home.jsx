...
const Home = () => {
  return (
    <div className="bg-main min-h-screen text-white px-8 md:px-20 lg:px-40 font-family">
      ...
      <div className="text-center pt-8 flex justify-center flex-col font-family md:text-xs">
        <h1 className="text-4xl md:text-6xl">Welcome To</h1>{" "}
        <span className="text-4xl md:text-6xl font-semibold green-grade">
          Bharat Kaa Coders
        </span>
      </div>
        ...
        <div className="left w-full md:w-3/5 md:pr-5">
          ...
          <div className="flex justify-end">
            <h2 className="text-zinc-500 md:w-4/5 text-right py-2">
              ...
              passionate about coding. Share insights, collaborate on projects,
              and engage in friendly competition with fellow coders from around
              the globe. Learning is more enjoyable when it's a shared
              experience!
            </h2>
          </div>
        </div>
